...
public class WikiPart {
	...
	public void postConstruct(MApplication application, Composite parent, MPart part) {
		...
		fd_tabFolder.top = new FormAttachment(pathField, 10);
		...
		fd_browser.top = new FormAttachment(pathField, 10);
...
// TODO		if (part.getLabel().startsWith("#")) {
...
//			LoadWikiPageJob job = new LoadWikiPageJob(ticketService, path, this);
//			job.schedule();
		} else {
			pathField.setMessage("");
		}
